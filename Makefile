...
OPTFLAGS += -funsigned-bitfields
OPTFLAGS += -fpack-struct

OPTFLAGS += -ffunction-sections
OPTFLAGS += -fdata-sections

OPTFLAGS += -fno-jump-tables
OPTFLAGS += -fno-unit-at-a-time
OPTFLAGS += -fno-inline-small-functions 
OPTFLAGS += -fno-split-wide-types 
OPTFLAGS += -fno-tree-scev-cprop 
...
AVRDUDE_PORT = /dev/tty.usbserial-A7005tw9
...
HEXSIZE = $(SIZE) --target=sysv $(TARGET).hex
