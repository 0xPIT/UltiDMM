// ---------------------------------------------------------------------------- 
// Access Dallas 1-Wire Devices with ATMEL AVR
//
// (c) Peter Dannegger (danni(at)specs.de)
// (c) Martin Thomas (mthomas(at)rhrk.uni-kl.de)
//
// ChangeLog:
// 09/2004 - use of delay.h, optional bus configuration at runtime
// 10/2009 - additional delay in ow_bit_io for recovery
// 05/2010 - timing modifcations, additonal config-values and comments,
//           use of atomic.h macros, internal pull-up support
// 07/2010 - added method to skip recovery time after last bit transfered
//           via ow_command_skip_last_recovery
// ---------------------------------------------------------------------------- 

#ifndef __have_onewire_h__
#define __have_onewire_h__
...
#ifndef OW_ONE_BUS
extern void ow_set_bus(volatile uint8_t *in, volatile uint8_t *out, volatile uint8_t *ddr, uint8_t pin);
#endif
